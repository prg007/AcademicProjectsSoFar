...
Deep Learning: A convolutional neural network is built that utilises max pooling and padding with kernel sizes of 3 to differentiate pictures of zebra with an accuracy of greater than 90%.
